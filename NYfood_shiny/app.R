...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("Nombre de notes des restaurants français par quartier"),

    # Sidebar with a slider input for number of bins 
    amChartsOutput("barplot")
)
...
server <- function(input, output) {
  ...
  output$barplot <- renderAmCharts(amBarplot(y = c("A", "B", "C", "Not Yet Graded", "P", "Z"), data = final_dataset, stack_type = "regular")  %>% 
